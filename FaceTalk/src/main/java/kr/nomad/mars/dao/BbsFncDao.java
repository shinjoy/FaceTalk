...
public class BbsFncDao {
	...
	private RowMapper VbbsfncMapper = new RowMapper() {
		public BbsFnc mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			bbsfnc.setSite(rs.getString("site"));
			bbsfnc.setSiteName(rs.getString("site_name"));
			return bbsfnc;
		}
	};
	...
	public List<BbsFnc> getadBbsFncList(String site,int userType,String startDate,String endDate,int fncReason,String keyword,String sort,String colname,int page,int itemCountPerPage) {
	...
	public int getadCount(String site,int userType,String startDate,String endDate,int fncReason,String keyword) {
		String con ="where 1=1";
