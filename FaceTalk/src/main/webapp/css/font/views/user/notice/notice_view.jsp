...
<body>
	...
	<div class="login-wrap">
		...
		<div class="login-content">
			...
			<div class="login-content" >
				<div class="inner">
					<div class="login-title">공지사항 > 상세보기</div>
					...
					<div style=" padding-left:30px; padding-top:30px; width:950px;">
						...
						<colgroup>
							...
							<tr style="background-color:#20BBD9; border-top:2px solid #0782BD; height:30px; border-bottom:2px solid #ddd;">
								<td style="padding-left:30px; color:#fff;">${notice.seq}. ${notice.title}</td>
								<td style="color:#fff;">${notice.regDate.substring(0,16)}</td>
							</tr>
<!-- 							<tr> -->
...
<!-- 							</tr> -->
							<tr>
								<td class="bbs-contents" colspan="2" style="color:#000; padding-left:30px; padding-top:10px;">${notice.contentsHtml}</td>
							</tr>
						</table>
			...
			<div class="btnC" style="padding-left:450px; padding-bottom:10px; padding-top:10px;">
				<button type="button" class="btn" onclick="document.location.href='/user/notice/notice.go';" >목록</button>
			</div>		
