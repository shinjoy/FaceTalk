					...
					<table>
						...
						<tr>
							...
							<td style="padding:10px;">
								<input type="text" name="userId" class="fbox" style="width: 180px;" placeholder="아이디를 입력하세요" >
							</td>
						</tr>
						<tr>
							<th>비밀번호</th>
							<td style="padding: 10px;">
								<input type="password" name="userPw" class="fbox" style="width: 180px;" placeholder="비밀번호를 입력하세요"  onkeydown="passwordSafeCheck(this.form, this);">
						...
						<tr>
							<th>비밀번호 확인</th>
							<td style="padding: 10px;">
								<input type="password" name="userPwConfirm" class="fbox" style="width: 180px;" placeholder="비밀번호를 확인하세요">
							</td>
						</tr>
						...
						<tr>
							<th>이름</th>
							<td style="padding: 10px;">
								<input type="text" name="userName" class="fbox" style="width: 180px;" placeholder="이름을 입력하세요">
							</td>
						</tr>
						...
						<tr>
							...
							<td style="padding: 10px;">
								<p>
								<input type="text" name="age" class="fbox" style="width: 180px;" placeholder="나이를 입력하세요"> (태어난 년도를 입력해주세요. ex)1992)
								</p>
								<P>
						...
						<tr>
							<td>&nbsp;</td>
							<td>
								<input type="button" name="go" class="btn" style="width:180px; margin-left:10px; text-align: center;" value="회원가입" onclick="formCheck(this.form)">
							</td>
						</tr>
