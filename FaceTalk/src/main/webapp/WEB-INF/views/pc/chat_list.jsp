...
<%@ include file="/WEB-INF/views/pc/head.jsp"  %>
	...
	<script type="text/javascript">
		...
		function openSelectorPop() {
			pop.openWindow("/pc/chat_user.go?agentId="+searchForm.userId.value, 'chatUser', 1040, 800, 'yes', 'yes');
		}
