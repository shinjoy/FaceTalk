			...
			<c:choose>
				<c:when test="${list.size() > 0}">
					...
					<tr>
						...
						<td rowspan="4">
							<a href="/admin/banner/banner_edit.go?seq=${it.bannerSeq}"> 
								<img src="${it.contentsHtml}" style="max-height:80px; width:350px;">
							</a>
						</td>
					</tr>
					<tr>
						<td style="padding-left:10px; text-align:left;">${it.siteName}</td>
					</tr>
					<tr>
