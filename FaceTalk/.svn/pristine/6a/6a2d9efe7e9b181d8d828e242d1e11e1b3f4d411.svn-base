			...
			<form name="loginCheck" method="post" class="log_form" onsubmit="return false">
				...
				<div class="log-wrap-join">
					...
					<table style="padding:10px;">
						<tr>
							<td>&nbsp;</td>
							<td style="padding-left:10px; padding-bottom:10px;">이용약관</td>
						</tr>
						<tr>
							<td >&nbsp;</td>
						...
						<tr>
							<td>&nbsp;</td>
							<td style="padding-left:10px; padding-bottom:10px; padding-top:30px;">개인정보 취급방침</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td style="padding: 0px;">
						...
						<tr>
							<td>&nbsp;</td>
							<td>
								<input type="button" name="go" class="btn" style="width:180px; margin-top:10px; margin-left:380px; text-align: center;" value="다음" onclick="formCheck(this.form)">
							</td>
						</tr>
