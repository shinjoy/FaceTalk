	...
	<section id="main">
		...
		<section id="contents">
			...
			<div class="contents-block">
				...
				<div  class="btn-tools" >
					<button type="button" class="btn" onclick="submitForm(printcenterForm);">업체 수정</button>	
					<button type="button" class="btn" onclick="submitForm(printcenterForm);">업체 삭제</button>		
