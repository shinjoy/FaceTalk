...
public class ChatRoomDao {
	...
	private RowMapper mychatroomMapper = new RowMapper() {
		public ChatRoom mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			chatroom.setMemphoto(rs.getString("memphoto"));
			chatroom.setMemgender(rs.getInt("memgender"));
			return chatroom;
		}
	};
	...
	private RowMapper chatroomMapperdis = new RowMapper() {
		public ChatRoom mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			chatroom.setAgentId(rs.getString("agent_id"));
			chatroom.setAgentName(rs.getString("agent_name"));
			chatroom.setSite(rs.getString("site"));
			chatroom.setSiteName(rs.getString("site_name"));
			return chatroom;
		}
	};
	...
	public int getChatRoomcount(int userType,String site) {
		...
		String query = "" +
			"select count(*) from v_nf_chat_room "+con;
	...
	// 확성기를 사용하지 않는 일반 채팅방
	public List<ChatRoom> getChatRoomNormalList(String site,int page, int itemCountPerPage, String keyword, int age, int gender, String area, int distance, Double latitude, Double longitude) {
	...
	// 채팅방 갯수
	public int getChatRoomNormalCount(String site,String keyword, int age, int gender, String area, int distance, Double latitude, Double longitude) {
		String condition = " WHERE chat_room_type in (1,2,3,4) ";
	...
	public List<ChatRoom> getChatRoomSpeakerList(String keyword, int age, int gender, String area, int distance, Double latitude, Double longitude) {
		...
		public List<ChatRoom> getChatRoomAdminList(String site,int userType,int page, int itemCountPerPage, String keyword, int age, int gender, String area, int distance, Double latitude, Double longitude) {
			String condition = " WHERE chat_room_type in (1,2,3,4) ";
		...
		// 채팅방 갯수
		public int getChatRoomAdminCount(String site,int userType,String keyword, int age, int gender, String area, int distance, Double latitude, Double longitude) {
			String condition = " WHERE chat_room_type in (1,2,3,4) ";
