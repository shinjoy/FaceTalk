...
// 		keyword		: 	listForm.keyword.value,
	...
	$.ajax({
		type:"POST",
		url:"/admin/banner/banner_list.go",
		dataType:"html",
		data:param,
...
<!-- 									<button type="submit" class="btn">검색</button> -->
								...
								<div class="btn-tools"><button type="button" class="btn-blue" onclick="document.location.href='/admin/banner/banner_edit.go?seq=0'">배너 광고 등록</button></div>
							</div>
						</div>
