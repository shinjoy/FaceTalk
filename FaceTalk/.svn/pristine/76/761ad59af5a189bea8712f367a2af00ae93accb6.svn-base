...
public class PointMoneyDao {
	...
	private RowMapper pointmoneyMapper2 = new RowMapper() {
		public PointMoney mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			pointmoney.setSite(rs.getString("site"));
			pointmoney.setSiteName(rs.getString("site_name"));
			return pointmoney;
		}
	};	
	...
	public List<PointMoney> getPointMoneyList(String site,int userType,String colName,String sort,String type, String keyword, String startDate, String endDate, int page, int itemCountPerPage) {
	...
	public int getHistoryCnt(String site,int userType,String type,String keyword,String startDate, String endDate){
	...
	public List<PointMoney> getVmyList(String userId,int page,int itemCountPerPage) {
		...
		String query = ""  
			    ...
			    +" * "
				+" FROM V_NF_MYPOINT where user_id = ? and kind in (1,2,3,4,5,6) "
		  		+ ") AS a WHERE row_seq BETWEEN (("+page+" - 1) * "+itemCountPerPage+") +1 AND "+page+" * "+itemCountPerPage+" ";
